...
const primary: ButtonConfig = {
  solid: {
    ...
    disabled: {
      backgroundColor: theme.colors.neutral.primary['90'],
      borderColor: theme.colors.neutral.primary['90'],
      color: theme.colors.neutral.primary['100'],
    },
    hover: {
  ...
  outlined: {
    ...
    hover: {
      backgroundColor: theme.colors.brand.primary['90'],
      borderColor: theme.colors.brand.secondary['70'],
  ...
  ghost: {
    ...
    disabled: {
      color: theme.colors.neutral.primary['90'],
    },
    hover: {
      backgroundColor: theme.colors.brand.primary['90'],
      borderColor: theme.colors.brand.primary['90'],
      color: theme.colors.brand.secondary['100'],
    },
    active: {
      backgroundColor: theme.colors.brand.primary['100'],
...
const quaternary: Partial<ButtonConfig> = {
  outlined: {
    ...
    hover: {
      backgroundColor: theme.colors.brand.primary['90'],
      borderColor: theme.colors.neutral.primary['100'],
      color: theme.colors.neutral.secondary['100'],
    },
    active: {
      backgroundColor: theme.colors.brand.primary['100'],
